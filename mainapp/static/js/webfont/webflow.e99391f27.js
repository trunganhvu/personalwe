...
! function(t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = _, e.getIn = g, e.set = y, e.setIn = m, e.update = I, e.updateIn = T, e.merge = O, e.mergeDeep = b, e.mergeIn = A, e.omit = w, e.addDefaults = S;
    /*!
     * Timm
     *
    ...
    n(121), n(123), n(65), n(125), n(313), n(314), n(315), n(316), t.exports = n(321)
}, function(t, e, n) {
    "use strict";
    var r = n(6);
                    ...
                    switch (u) {
                        ...
                        case ct:
                            var _ = dt[u],
                                ...
                                I = n.aValue;
                            xt(t, _, o), a(t, _, I >= 1 ? "rgb(".concat(g, ",").concat(y, ",").concat(m, ")") : "rgba(".concat(g, ",").concat(y, ",").concat(m, ",").concat(I, ")"));
                            break;
                        default:
                            var T = c.unit,
                                O = void 0 === T ? "" : T;
    ...
    function yt(t) {
        ...
        var w, S, R, N = (0, p.default)(n, "action.config.affectedElements", {})[g || I] || {},
        ...
        return null == S || null == R ? [] : y.IS_BROWSER_ENV && i ? c(R).filter(function(t) {
            return i.contains(t)
        }) : w === G ? c(S, R) : w === X ? s(c(S)).filter(l(R)) : w === k ? f(c(S)).filter(l(R)) : c(R)
    }
    var mt = /px/,
        It = function(t, e) {
        ...
        T = function(t, e) {
            ...
            for (var A = 0, w = i.length; A < w; A++) {
                ...
                if (0 === A && (E = N[0]), b >= R) {
                    ...
                    var x = i[A + 1],
                        C = x && b !== R;
                    _ = C ? x.actionItems[0] : null, C && (g = R / 100, m = (x.keyframe - R) / 100)
                }
            }
            var L = {};
            if (E && !_)
                for (var D = 0, P = a.length; D < P; D++) {
                    ...
                    for (var j = (O - g) / m, F = E.config.easing, G = h(F, j, f), X = 0, k = a.length; X < k; X++) {
                        var V = a[X],
                            U = y(s, V, E.config),
                            W = (y(s, V, _.config) - U) * G + U;
                        L[V] = W
                    }
            return (0, o.merge)(t, {
                position: O,
    ...
    var c, s, f, l = u(n(27)),
        ...
        _t = (r = {}, (0, o.default)(r, R, vt()), (0, o.default)(r, N, ht()), (0, o.default)(r, S, vt()), (0, o.default)(r, w, ht()), (0, o.default)(r, D, vt(!1)), (0, o.default)(r, L, ht(!1)), (0, o.default)(r, x, vt()), (0, o.default)(r, C, ht()), (0, o.default)(r, U, {
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function m(e, n) {
            ...
            i.handler = null, i.redirect = r.attr("data-redirect"), g.test(u) ? i.handler = A : u || (o ? i.handler = b : y())
        }
    ...
    r.define("navbar", t.exports = function(t, e) {
        ...
        function X(t, e) {
            if (!t.open) {
                t.open = !0, t.menu.each(F), t.links.addClass(I), t.dropdowns.addClass(g), t.dropdownToggle.addClass(y), t.dropdownList.addClass(m), t.button.addClass(_);
                var n = t.config;
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "c66b3b9e-8533-cf7e-3626-5291fef080a4"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-3": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "53a7664c-23a9-741b-01d1-3dbb83626754"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
        ...
        "e-9": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5e4b197bdc74af9bb94a9e3b|8dc1b770-c525-3040-95bf-dfd37665fd1c"
            },
            "config": {
                "loop": false,
                "playInReverse": false,
    ...
    "actionLists": {
        "a": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["5edd637a-6cc9-bf7e-7687-509cfd97295c"]
                        },
                        "xValue": 1.2,
                        "yValue": 1.2,
                        "locked": true
            ...
            "createdOn": 1582926986758,
            "useFirstGroupAsInitialState": true
        },
        "a-2": {
            "id": "a-2",
            "title": "Close Contact Overlay",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-2-n",
                    "actionTypeId": "TRANSFORM_SCALE",
        ...
        "a-3": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["b858f589-ab1c-8332-7004-bec3b2469c58"]
                        },
                        "yValue": -30,
                        "xUnit": "PX",
                        "yUnit": "PX",
            ...
            "createdOn": 1582927371979,
            "useFirstGroupAsInitialState": true
        },
        "a-4": {
            "id": "a-4",
            "title": "Home Page Tiles On Page Load",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-4-n",
                    "actionTypeId": "TRANSFORM_SCALE",
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e4b197bdc74af5de04a9e31|e8c4e4c4-cea0-8f1e-cb08-86aed56ea0ae"
                        },
                        "xValue": 0.96,
                        "yValue": 0.96,
                        "locked": true
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e4b197bdc74af5de04a9e31|1cb6be37-64c6-c643-588d-1c32f82daad6"
                        },
                        "xValue": 0.96,
                        "yValue": 0.96,
                        "locked": true
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e4b197bdc74af5de04a9e31|0bfbbced-82b7-9203-cafc-59fe76b2d597"
                        },
                        "xValue": 0.96,
                        "yValue": 0.96,
                        "locked": true
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e4b197bdc74af5de04a9e31|e398461a-51dc-a791-a4b1-a385a6c06359"
                        },
                        "xValue": 0.96,
                        "yValue": 0.96,
                        "locked": true
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5e4b197bdc74af5de04a9e31|c23cfaee-2245-1780-bfb9-ef0995541f3e"
                        },
                        "xValue": 0.96,
                        "yValue": 0.96,
                        "locked": true
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".blog-image",
                            "selectorGuids": ["249da498-2e6e-c721-46b9-46209ffb0eab"]
                        },
                        "xValue": 1,
                        "yValue": 1,
                        "locked": true
